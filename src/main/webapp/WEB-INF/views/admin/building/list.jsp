...
<%--                                            <input type="number" class="form-control" name="numberOfBasement" value=${modelSearch.numberOfBasement}>--%>
                                                <form:input path="numberOfBasement" type="number" class="form-control" min="0" />
...
<script>
    const districtsByCity = {
        ...
        "DN": [ // Đà Nẵng
            ...
            { code: "LK", name: "Liên Chiểu" },
            { code: "NT", name: "Ngũ Hành Sơn" },
            { code: "CL", name: "Cẩm Lệ" },
            { code: "TL", name: "Thanh Khê" },
            { code: "HP", name: "Hòa Vang" }
        ]
    };
</script>
