...
//Immutable: TÍnh toàn vẹn dữ liệu
//Một class xếp loại là immutable class nếu các bản thể (instance) của nó không thể thay đổi được
